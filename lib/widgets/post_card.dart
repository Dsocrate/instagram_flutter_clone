...
//we can get the number of comments from the post collection since the comment is a sub_collection on our firebase
  // so we use a streambuilder or future builder to fetch it from firebase
